...
// is what `plays_by_player_recent` in migrations/0001_initial_schema.sql exists
// to serve. Without that index each of those seeks is a full table scan, and
// since the overlay polls both boards continuously that reads millions of rows a
// day out of a table holding a few hundred. The results are identical either
// way, so test_leaderboard.mjs asserts the plan rather than the rows.
//
